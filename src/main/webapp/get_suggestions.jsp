...
<body style="background-color: skyblue;">
    <div class="container">
        ...
        <h1>Get Suggestions For Your Disease</h1>
        
        <form style="width: 50%; height:100%;" action="info2" method="post">
...
<td style="background-color:yellow;">Avg Rating</td>
<td style="background-color:yellow;">Number Of People Using This</td>
</tr>
...
try {
    ...
    <br><br><br>
    <h1>Username : <%=hi%></h1>
    <h1>Search Rersult For : <%=d%></h1>
    <br><br><br>
    <%
    String qry = "select * from datas where udisease = '"+d+"'";
...
<tr>
<td><%=kk%></td>
<td><%=(df.format((double)((double)kk2/(double)kk3)))%></td>
<td><%=kk3%></td>
</tr>
